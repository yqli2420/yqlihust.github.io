...
<div class="data_list">
    <div class="data_list_title">
        <c:choose>
            ...
            <c:otherwise>
                <img src="${pageContext.request.contextPath}/image/diaryType_add_icon.png"/>
                添加日记类别
            </c:otherwise>

        </c:choose>
    </div>
    <form action="${pageContext.request.contextPath}/diaryTypeServlet?action=save" method="post"
